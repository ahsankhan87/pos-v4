...
<?php if (!isset($supplier) || !is_array($supplier)): ?>
    <div class="max-w-3xl mx-auto p-4">
        <div class="bg-red-50 text-red-700 border border-red-200 rounded-lg p-3"><?= lang('Suppliers.supplier_not_found') ?></div>
    </div>
<?php else: ?>
            ...
            <div class="max-w-6xl mx-auto px-4">
                <div class="h-12 flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        <h1 class="text-lg font-bold text-gray-900"><?= lang('Suppliers.edit_supplier') ?></h1>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div class="p-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label class="block text-xs font-semibold text-gray-700 mb-1"><?= lang('Suppliers.email') ?> <span class="text-red-500">*</span></label>
                ...
                <div class="space-y-4">
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden sticky top-16">
                        ...
                        <div class="p-4 space-y-2">
                            <button type="submit" class="btn btn-primary w-full"><i class="fas fa-check"></i> <?= lang('Suppliers.update') ?></button>
