...
<head>
    ...
    <title><?= esc($title ?? (lang('Reports.unit_wise_sales_report') . ' - ' . lang('Reports.print'))) ?></title>
    <style>
        body {
    ...
    <table>
        ...
        <tbody>
            <?php foreach (($rows ?? []) as $row): ?>
                <tr>
                    <td><?= esc($row['unit_name'] ?? '—') ?><?= !empty($row['abbreviation']) ? ' (' . esc($row['abbreviation']) . ')' : '' ?></td>
