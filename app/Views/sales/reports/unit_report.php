...
<div class="max-w-7xl mx-auto print-root">
    <div class="bg-white shadow rounded-lg mb-6">
        <div class="px-6 py-5 border-b border-gray-100 flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4">
            <div>
                <h2 class="text-2xl font-bold text-gray-900"><?= lang('Reports.unit_wise_sales_report') ?></h2>
            ...
            <form method="get" class="no-print grid grid-cols-1 sm:grid-cols-2 md:grid-cols-6 gap-3 w-full lg:w-auto">
                ...
                <div class="flex items-end gap-2">
                    ...
                    <?php if (can('reports.unit_sales')): ?>
                        <a href="<?= site_url('sales/unit-report/print?from=' . urlencode($from) . '&to=' . urlencode($to) . ($employee_id ? ('&employee_id=' . urlencode($employee_id)) : '')) ?>" target="_blank" class="inline-flex items-center px-4 py-2 rounded-md bg-gray-700 text-white hover:bg-gray-800 shadow-soft"><i class="fas fa-print mr-2"></i> <?= lang('Reports.print') ?></a>
                    <?php endif; ?>
                </div>
