<div class="max-w-6xl mx-auto bg-white p-8 rounded shadow-lg mt-8">
    <h2 class="text-3xl font-bold mb-6 text-blue-700">Create Sale</h2>
    ...
    <form method="post" action="<?= site_url('sales/create') ?>">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            ...
            <div>
                <label class="block mb-1 font-semibold">Scan product Barcode</label>
                ...
                <!-- <label class="block mb-1 font-semibold mt-4">Category</label>
            ...
            <div>
                ...
                <label class="block mb-1 font-semibold mt-4">Tax (%)</label>
                <input type="number" id="taxRate" name="tax_rate" value="18" min="0" max="100" class="w-full border rounded px-3 py-2 mb-4">
        ...
        <div class="flex justify-end gap-4">
            ...
            <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700 font-bold">Complete Sale</button>
        </div>
    </form>
</div>
<!-- Select2 CDN -->
