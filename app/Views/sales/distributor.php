        ...
        <?php if (isset($resumeDraftId)): ?>
            ...
            <script>
                window.__DRAFT_PREFILL__ = {
                    ...
                    zatcaInvoiceType: <?= json_encode(old('zatca_invoice_type', $zatcaDefaultInvoiceType ?? '')) ?>
                };
            </script>
...
<script>
    $(document).ready(function() {
        ...
        function validateImeiSelections(items) {
            const errors = [];
            (items || []).forEach((item) => {
        ...
        $('form').on('submit', function(e) {
            ...
            const allErrors = limitErrors.concat(imeiErrors);
            ...
            try {
                cart = (window.__DRAFT_PREFILL__.cart || []).map(function(it) {
                    return {
                        ...
                        requires_imei: parseInt(it.requires_imei || 0, 10) || 0,
                ...
                if (window.__DRAFT_PREFILL__.zatcaInvoiceType !== undefined) {
