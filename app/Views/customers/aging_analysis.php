        ...
        <div class="mb-6">
            <div class="flex items-center justify-between mb-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">Aging Analysis</h1>
                        <p class="text-gray-600 mt-1">Payment aging breakdown and outstanding invoices</p>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-orange-600 to-red-600 rounded-xl shadow-lg p-6 text-white">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-right">
                            <p class="text-orange-100 text-sm">Total Outstanding</p>
        ...
        <?php if (!empty($agingBuckets) && $outstanding > 0): ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-lg transition-all duration-200">
                    ...
                    <p class="text-xs font-bold text-gray-500 uppercase mb-2">0–30 Days</p>
                    ...
                    <p class="text-xs text-gray-500 mt-2"><?= $outstanding > 0 ? number_format(($agingBuckets['0_30'] ?? 0) / $outstanding * 100, 1) : 0 ?>% of total</p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-lg transition-all duration-200">
                    ...
                    <p class="text-xs font-bold text-gray-500 uppercase mb-2">31–60 Days</p>
                    ...
                    <p class="text-xs text-gray-500 mt-2"><?= $outstanding > 0 ? number_format(($agingBuckets['31_60'] ?? 0) / $outstanding * 100, 1) : 0 ?>% of total</p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-lg transition-all duration-200">
                    ...
                    <p class="text-xs font-bold text-gray-500 uppercase mb-2">61–90 Days</p>
                    ...
                    <p class="text-xs text-gray-500 mt-2"><?= $outstanding > 0 ? number_format(($agingBuckets['61_90'] ?? 0) / $outstanding * 100, 1) : 0 ?>% of total</p>
                </div>
                ...
                <div class="bg-gradient-to-br from-red-500 to-red-600 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-200 text-white">
                    ...
                    <p class="text-xs font-bold uppercase mb-2 text-red-100">90+ Days</p>
                    ...
                    <p class="text-xs mt-2 text-red-100"><?= $outstanding > 0 ? number_format(($agingBuckets['90_plus'] ?? 0) / $outstanding * 100, 1) : 0 ?>% of total - <strong>Action Required!</strong></p>
                </div>
            </div>
        <?php endif; ?>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <?php if (empty($invoices)): ?>
                <div class="p-12 text-center">
                    ...
                    <p class="text-xl font-semibold text-gray-700 mb-2">No Outstanding Invoices</p>
                    <p class="text-gray-500">This customer has cleared all payments</p>
                </div>
            <?php else: ?>
                    ...
                    <table class="w-full">
                        <thead class="bg-gray-50 border-b border-gray-200">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-right text-xs font-bold text-gray-700 uppercase">Age (Days)</th>
                                <th class="px-6 py-4 text-right text-xs font-bold text-gray-700 uppercase">Total Amount</th>
                                <th class="px-6 py-4 text-right text-xs font-bold text-gray-700 uppercase">Paid</th>
                                <th class="px-6 py-4 text-right text-xs font-bold text-gray-700 uppercase">Due Amount</th>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold <?= $ageClass ?>">
                                            <?= ucfirst($invoice['payment_status'] ?? 'due') ?>
                                        </span>
                                    </td>
                        ...
                        <tfoot class="bg-gray-50 border-t-2 border-gray-300">
                            <tr>
                                <td colspan="5" class="px-6 py-4 text-right font-bold text-gray-900">Total Outstanding:</td>
                                <td class="px-6 py-4 text-right">
