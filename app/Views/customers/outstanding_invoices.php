            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div>
                    <div class="flex items-center gap-3 mb-2">
                        ...
                        <h1 class="text-3xl font-bold text-gray-900">Outstanding Invoices</h1>
                    </div>
                    <?php if ($customer): ?>
                        <div class="ml-12 flex items-center gap-4 text-sm text-gray-600">
                            <div class="flex items-center gap-2">
                                <i class="fas fa-user text-blue-600"></i>
                                <span class="font-semibold text-gray-900"><?= esc($customer['name'] ?? 'Unknown') ?></span>
                            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 hover:shadow-md transition-shadow">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-sm font-medium text-gray-600">Total Outstanding</span>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 hover:shadow-md transition-shadow">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-sm font-medium text-gray-600">Total Invoices</span>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 hover:shadow-md transition-shadow">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-sm font-medium text-gray-600">Oldest Invoice</span>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 hover:shadow-md transition-shadow">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-sm font-medium text-gray-600">Average Due</span>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <?php if (empty($invoices)): ?>
                ...
                <div class="py-16 text-center">
                    ...
                    <p class="text-gray-600">This customer has no outstanding invoices.</p>
                </div>
            <?php else: ?>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            ...
                            <div class="text-sm font-semibold text-gray-900">
                                Total Due: <span id="selectedTotal" class="text-blue-600"><?= $currencySymbol ?>0.00</span>
                            </div>
                        </div>
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl transform transition-all duration-300 scale-95 opacity-0 modal-content">
            <div class="px-6 py-5 bg-gradient-to-r from-green-600 to-emerald-600 rounded-t-2xl">
                <div class="flex items-center justify-between text-white">
                    <div>
                        <h3 class="text-xl font-bold">Quick Payment</h3>
                        <p class="text-sm text-white/80 mt-1">Pay selected invoices</p>
                    </div>
            ...
            <div class="p-6">
                <form id="quickPayForm">
                    ...
                    <div class="mb-5">
                        ...
                        <p class="mt-2 text-sm text-gray-600">Selected invoices total: <span id="modalSelectedTotal" class="font-bold text-green-600">-</span></p>
                    </div>
