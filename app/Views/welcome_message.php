    ...
    <header>
        ...
        <div class="menu">
            <ul>
                ...
                <li class="menu-item hidden"><a href="<?= site_url('home') ?>">Home</a></li>
                <li class="menu-item hidden"><a href="<?= site_url('about') ?>">About</a></li>
                <li class="menu-item hidden"><a href="<?= site_url('contact') ?>">Contact</a></li>
