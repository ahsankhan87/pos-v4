...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500"><?= esc(lang('Reports.customers_outstanding_balances_with_print_and_export')) ?></p>
        </div>
    ...
    <div class="table-card">
        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
            <h2 class="text-lg font-semibold text-gray-900"><?= esc(lang('Reports.debtors_summary')) ?></h2>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const dtTexts = {
            ...
            searchCustomers: <?= json_encode(lang('Reports.search_customers_placeholder'), JSON_UNESCAPED_UNICODE) ?>,
        ...
        const table = $('#debtorsTable').DataTable({
            ...
            buttons: [{
                    ...
                    customize: function(win) {
                        ...
                        $footerRow.html('<td colspan="4" style="font-weight:bold;">' + dtTexts.totalsUpper + '</td><td style="text-align:right;font-weight:bold;">' + currency + openingTotal.toFixed(2) + '</td><td style="text-align:right;font-weight:bold;">' + currency + debitsTotal.toFixed(2) + '</td><td style="text-align:right;font-weight:bold;">' + currency + creditsTotal.toFixed(2) + '</td><td style="text-align:right;font-weight:bold;">' + currency + balanceTotal.toFixed(2) + '</td><td></td>');
            ...
            language: {
                search: "_INPUT_",
                searchPlaceholder: dtTexts.searchCustomers,
