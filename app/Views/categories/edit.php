...
<div class="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-6">
    <!-- Page Header -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900"><?= lang('Categories.editCategory') ?></h1>
        <p class="mt-1 text-sm text-gray-500"><?= lang('Categories.editSubtitle') ?></p>
    </div>
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg p-6">
        <form action="<?= site_url('categories/update/' . $category['id']) ?>" method="POST">
            ...
            <div class="flex justify-end">
                ...
                <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"><?= lang('Categories.updateCategory') ?></button>
            </div>
        </form>
    </div>
</div>
