...
<div class="max-w-3xl mx-auto py-6">
    <div class="bg-white shadow rounded p-6">
        <h1 class="text-2xl font-bold mb-6">Add Unit</h1>
        ...
        <form action="<?= site_url('units/create') ?>" method="post" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" name="abbreviation" value="<?= old('abbreviation') ?>" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2" placeholder="e.g. pcs, kg, box">
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-700">Description</label>
                <textarea name="description" rows="3" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2" placeholder="Optional description"><?= old('description') ?></textarea>
            </div>
