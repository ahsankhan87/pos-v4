...
<div class="container mx-auto px-4 py-6">
    <h1 class="text-3xl font-bold text-gray-800 mb-6"><?= lang('Users.add_new_user') ?></h1>

    <?php $errors = session()->getFlashdata('errors'); ?>
    <?php if (! empty($errors)) : ?>
        <div class="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 mb-4" role="alert">
            <p class="font-bold"><?= lang('Users.please_fix_errors') ?></p>
    ...
    <?php if (session()->getFlashdata('success')) : ?>
        <div class="bg-green-100 border-l-4 border-green-500 text-green-700 p-4 mb-4" role="alert">
            <strong class="font-bold"><?= lang('Users.success') ?></strong>
        ...
        <form action="<?= site_url('users/create') ?>" method="post">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="name" id="name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2" value="<?= old('name') ?>">
                ...
                <div>
                    ...
                    <input type="text" name="username" id="username" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2" value="<?= old('username') ?>">
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2" value="<?= old('email') ?>">
                ...
                <div>
                    ...
                    <input type="text" name="phone" id="phone" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2" value="<?= old('phone') ?>">
                </div>
                <div>
                    <label for="password" class="block text-sm font-medium text-gray-700 mb-1"><?= lang('Users.password') ?></label>
                ...
                <div>
                    ...
                    <select name="preferred_locale" id="preferred_locale" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2">
                        <option value="en" <?= old('preferred_locale', config('App')->defaultLocale ?? 'en') === 'en' ? 'selected' : '' ?>><?= lang('Users.locale_en') ?></option>
                        <option value="ar" <?= old('preferred_locale') === 'ar' ? 'selected' : '' ?>><?= lang('Users.locale_ar') ?></option>
                    </select>
                ...
                <div class="col-span-1 md:col-span-2">
                    <label for="is_active" class="flex items-center text-sm font-medium text-gray-700 mb-1">
                        <input type="checkbox" name="is_active" id="is_active" class="h-4 w-4 text-blue-600 border-gray-300 rounded mr-2" value="1" <?= old('is_active') ? 'checked' : '' ?>>
