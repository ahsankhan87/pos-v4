...
$routes->group('sales', ['filter' => 'auth'], function ($routes) {
    ...
    $routes->get('category-report/export_excel', 'Sales::exportCategoryReportExcel', ['filter' => 'permission:sales.view']);
    $routes->get('category-report/export_pdf', 'Sales::exportCategoryReportPDF', ['filter' => 'permission:sales.view']);
    $routes->get('unit-report/export_excel', 'Sales::exportUnitReportExcel', ['filter' => 'permission:sales.view']);
    $routes->get('unit-report/export_pdf', 'Sales::exportUnitReportPDF', ['filter' => 'permission:sales.view']);
