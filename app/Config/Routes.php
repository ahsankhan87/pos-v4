...
$routes->group('sales', ['filter' => 'auth'], function ($routes) {
    ...
    $routes->get('category-pivot-report', 'Reports\Sales::categoryPivotReport', ['filter' => 'permission:reports.category_sales']);
    ...
    $routes->get('category-pivot-report/print', 'Reports\Sales::categoryPivotReportPrint', ['filter' => 'permission:reports.category_sales']);
